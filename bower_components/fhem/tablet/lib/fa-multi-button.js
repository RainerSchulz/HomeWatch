...
/**
* Modern toggle, push button, dimmer_gira or just a signal indicator
*
* Version: 1.1.1
...
$.fn.famultibutton = function(pOptions) {
	...
	var defaultOptions = {
		...
		mode: 'toggle',  //toggle, push, signal, dimmer_gira
		toggleOn: null,
		toggleOff: null,
        valueChanged: null,
        progressWidth:15,
...
function moveScale() {
	...
	else if (options['mode'] == 'dimmer_gira'){
		this.bind(clickEventType, function(e) {
