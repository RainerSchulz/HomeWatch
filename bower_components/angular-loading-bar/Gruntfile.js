...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    uglify: {
      ...
      build: {
        src: 'src/loading-bar.scripts',
        dest: 'build/loading-bar.min.scripts'
      }
    },
    ...
    karma: {
      unit: {
        configFile: 'test/karma-angular-1.2.conf.scripts',
        singleRun: true,
        coverageReporter: {
          type: 'text',
          dir: 'coverage/'
      ...
      unit13: {
        configFile: 'test/karma-angular-1.3.conf.scripts',
        singleRun: true,
        coverageReporter: {
          type: 'text',
          dir: 'coverage/'
    ...
    concat: {
      build: {
        ...
        files: {
          ...
          'build/loading-bar.js':  'src/loading-bar.scripts',
        }
      }
    }
  });
