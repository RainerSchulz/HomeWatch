    ...
    $('div[data-type="label"]').each(function(index) {
        switch($(this).attr('data-subtype')) {
            case "Temperature":
                ...
                $(this).attr('data-device', 'THSensorWZ');
                $(this).attr('data-unit', ' %B0C%0A');
                $(this).attr('data-limits', '[0,10,15,21,23]');
                $(this).attr('data-colors', '["#ffffff","#6699ff","#AF0539","#AD3333","#FF0000"]');
                break;
            case "Humidity":
                ...
                $(this).attr('data-colors', '["#ffffff","#6699ff","#AF0539","FFCC80","#AD3333","#FF0000"]');
                break;
        }
    });
    ...
    $('div[data-type="symbol"]').each(function(index) {
        switch($(this).attr('data-subtype')) {
            case "MAX":
                ...
                $(this).attr('data-on-background-colors', $(this).attr('data-on-background-colors') || '["#AF0539","#505050"]');
                ...
                $(this).attr('data-on-background-color', $(this).attr('data-on-background-color') || "#AF0539");
                break;
            case "POLLEN":
                $(this).attr('data-get-off', $(this).attr('data-get-off') || '0');
